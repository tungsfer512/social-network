...
return [
    ...
    'An unexpected error occurred. If this keeps happening, please contact a site administrator.' => 'Đã có lỗi xảy ra. Nếu tiếp tục lặp lại lỗi, vui lòng liên hệ với quản trị viên.',
    'An unexpected server error occurred. If this keeps happening, please contact a site administrator.' => 'Đã có lỗi xảy ra. Nếu tiếp tục lặp lại lỗi, vui lòng liên hệ với quản trị viên.',
    ...
    'Collapse' => 'Thu nhỏ',
    'Confirm' => 'Xác nhận',
    'Content Addon source must be instance of HActiveRecordContent or HActiveRecordContentAddon!' => 'Nguồn Content Addon phải là một phiên bản của HActiveRecordContent hoặc HActiveRecordContentAddon!',
    ...
    'The space has been archived.' => 'Nhóm đã được đưa vào lưu trữ.',
    'The space has been unarchived.' => 'Nhóm đã được kích hoạt trở lại.',
    'Time Zone' => 'Múi giờ',
    ...
    'Allow content from external source' => 'Cho phép nội dung từ nguồn bên ngoài',
    'Always allow content from this provider!' => 'Luôn luôn cho phép nội dung từ nhà cung cấp này!',
    'Do you want to enable content from \'{urlPrefix}\'?' => 'Bạn có muốn kích hoạt nội dung từ \'{urlPrefix}\'?',
    'Stop impersonation' => 'Ngừng giả mạo',
    'Unsaved changes will be lost. Do you want to proceed?' => 'Những thay đổi chưa được lưu sẽ bị mất. Bạn có muốn tiếp tục?',
