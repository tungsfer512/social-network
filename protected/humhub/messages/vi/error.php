...
return [
    ...
    'Maintenance mode activated: You have been automatically logged out and will no longer have access the platform until the maintenance has been completed.' => 'Chế độ bảo trì được kích hoạt: Bạn đã tự động đăng xuất và sẽ không thể truy cập vào nền tảng cho đến khi bảo trì hoàn tất.',
    'Maintenance mode is active. Only Administrators can access the platform.' => 'Chế độ bảo trì đang hoạt động. Chỉ có Quản trị viên mới có thể truy cập vào hệ thống.',
    'The specified URL cannot be called directly.' => 'URL chỉ định không thể được gọi trực tiếp.',
    'You must change password.' => 'Bạn cần phải thay đổi mật khẩu.',
];
