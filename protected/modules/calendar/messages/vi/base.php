...
return [
    ...
    '{displayName} just added you to event "{contentTitle}" in space {spaceName} starting at {time}.' => '{displayName} vừa mới thêm bạn vào sự kiện "{contentTitle}" trong nhóm {spaceName} bắt đầu từ {time}.',
